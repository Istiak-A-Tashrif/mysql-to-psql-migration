...
Usage: 
    ...
    python mailgunemail_migration.py --phase=2
    python mailgunemail_migration.py --phase=3
    python mailgunemail_migration.py --full
    python mailgunemail_migration.py --verify
"""
...
def main():
    ...
    mysql_ddl, indexes, foreign_keys = get_mailgunemail_table_info()
    if not mysql_ddl:
        return
