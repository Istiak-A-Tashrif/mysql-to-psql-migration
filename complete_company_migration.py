#!/usr/bin/env python3
"""
Complete Company Table Migration Script
=======================================

This script does a complete migration of the Company table:
...
Usage: python complete_company_migration.py
"""
...
def create_postgresql_table(table_name, postgres_ddl):
    ...
    # Create a clean DDL - for company table specifically
    if table_name.lower() == 'company':
        clean_ddl = """CREATE TABLE company (
    ...
    tax DECIMAL(65,30) DEFAULT 0.000000000000000000000000000000,
    currency VARCHAR(191) DEFAULT 'USD',
    terms VARCHAR(800) DEFAULT NULL,
    policy VARCHAR(800) DEFAULT NULL,
    google_email VARCHAR(191) DEFAULT NULL,
    google_refresh_token VARCHAR(191) DEFAULT NULL,
    created_at TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    companyLatitude DOUBLE PRECISION DEFAULT NULL,
    companyLongitude DOUBLE PRECISION DEFAULT NULL,
    zapierToken VARCHAR(240) DEFAULT NULL,
    twilioCredentialsId INTEGER DEFAULT NULL,
    mailgunCredentialId INTEGER DEFAULT NULL,
    google_calendar_token VARCHAR(191) DEFAULT NULL,
    stripeAccountId VARCHAR(191) DEFAULT NULL,
    timezone VARCHAR(191) DEFAULT NULL,
    serviceFee DECIMAL(65,30) DEFAULT 0.000000000000000000000000000000
)"""
    else:
...
def export_and_clean_mysql_data(table_name):
    ...
    expected_columns = 32  # Default for company
...
def migrate_company_complete():
    """Complete company table migration"""
    table_name = "Company"
